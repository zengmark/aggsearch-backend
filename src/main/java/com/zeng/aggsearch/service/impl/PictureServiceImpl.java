package com.zeng.aggsearch.service.impl;
...
public class PictureServiceImpl implements PictureService{
    ...
    public Page<Picture> searchPicture(String searchText, long pageNum, long pageSize) {
        ...
        String url = String.format("https://www.bing.com/images/search?q=%s&form=HDRSC2&first=%s&cw=1177&ch=881", searchText, current);
        Document doc = null;
        try {
